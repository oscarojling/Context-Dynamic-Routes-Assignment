  ...
  return (
    <div className="p-4 max-w-3xl mx-auto">
      <div className="flex flex-col justify-between items-center mb-8 md:flex-row">
        ...
        <button
          className="cursor-pointer border border-black rounded-full px-5 py-3 mx-2 text-lg md:text-base hover:bg-primary hover:text-background hover:border-primary transition-colors"
